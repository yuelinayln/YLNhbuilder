			...
			var volumns = [86160000,79330000,102600000,104890000,90120000,87390000,88560000,86640000,68940000,78750000,71260000,69690000,90540000,101690000,93740000,94130000,91950000,248680000,99380000,85130000,89440000];
			var volumns1 = [89160000,79330000,92600000,104890000,79990000,134120000,83770000,92570000,109090000,100920000,181530000,8390000,88560000,86680000,68940000,73190000,197390000,78530000,69690000,90540000,248680000];
			...
			var dataMA20 = calculateMA(20, data);
				...
				if($(".iconfont").css('color','#000')){
					$(this).css('color','#39C612');
				}else{
					$(this).css('color','#000');
					}
				});
				$(".icon-kuangcai").on('click',function(){
					if($(".iconfont").css('color','#000')){
						$(this).css('color','red');
					}else{
						$(this).css('color','#000');
				...
				if($.trim($(this).html())=="亚太"){
					location.href="information.html";
				}else if($.trim($(this).html())=="北美"){
					location.href="financial_detail.html";
				}else if($.trim($(this).html())=="欧洲"){
					location.href="information_detail.html";
				}else if($.trim($(this).html())=="期货"){
					location.href="financial_detail.html";
				}else if($.trim($(this).html())=="外汇"){
					location.href="financial.html";
				}
				
				
			});
			$('.mui-tab-item .mui-tab-label').click(function(){
